...
function AppServer() {
  ...
  this.server.post('/siswa/v1/prestasi', jwtAuth.verifyToken, handler.addPrestasi);
  this.server.patch('/siswa/v1/prestasi/:prestasi_id', jwtAuth.verifyToken, handler.deletePrestasi);
